...
import AdminTable from '@/app/admin/gallery/AdminTable';
import { Fragment } from 'react';
import DeleteFormButton from '@/app/admin/gallery/DeleteFormButton';
import { photoQuantityText } from '@/features/gallery/photo';
import { Tags, formatTag, sortTagsObject } from '@/features/gallery/tag';
import EditButton from '@/app/admin/gallery/EditButton';
