...
} from '@/features/gallery/services/storage/aws-s3';
import {
  cloudflareR2Client,
  cloudflareR2PutObjectCommandForKey,
} from '@/features/gallery/services/storage/cloudflare-r2';
import { CURRENT_STORAGE } from '@/features/gallery/site/config';
