...
import useClickInsideOutside from '@/features/gallery/hooks/useClickInsideOutside';
import { useRouter } from 'next/navigation';
import AnimateItems from './AnimateItems';
import { PATH_ROOT } from '@/features/gallery/site/paths';
import usePrefersReducedMotion from '@/features/gallery/hooks/usePrefersReducedMotion';
import useMetaThemeColor from '@/features/gallery/site/useMetaThemeColor';
