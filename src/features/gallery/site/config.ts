import { parseAiAutoGeneratedFieldsText } from '@/features/gallery/photo/ai';
import type { StorageType } from '@/features/gallery/services/storage';
import { makeUrlAbsolute, shortenUrl } from '@/features/gallery/utility/url';
