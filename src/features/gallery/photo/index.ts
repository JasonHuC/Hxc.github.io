import { Camera } from '@/features/gallery/camera';
import { formatFocalLength } from '@/features/gallery/focal';
import { Lens } from '@/features/gallery/lens';
import { getNextImageUrlForRequest } from '@/features/gallery/services/next-image';
import { FilmSimulation } from '@/features/gallery/simulation';
import { HIGH_DENSITY_GRID, SHOW_EXIF_DATA } from '@/features/gallery/site/config';
import { ABSOLUTE_PATH_FOR_HOME_IMAGE } from '@/features/gallery/site/paths';
import { formatDateFromPostgresString } from '@/features/gallery/utility/date';
import {
  formatAperture,
  formatIso,
