...
import { DEFAULT_ASPECT_RATIO, Photo, PhotoDbInsert, PhotoExif } from '../index';
import {
  convertTimestampToNaivePostgresString,
  convertTimestampWithOffsetToPostgresString,
  generateLocalNaivePostgresString,
  generateLocalPostgresString,
} from '@/features/gallery/utility/date';
import {
  convertApertureValueToFNumber,
  getAspectRatioFromExif,
  getOffsetFromExif,
} from '@/features/gallery/utility/exif';
import { roundToNumber } from '@/features/gallery/utility/number';
import { convertStringToArray } from '@/features/gallery/utility/string';
import { generateNanoid } from '@/features/gallery/utility/nanoid';
import {
  FILM_SIMULATION_FORM_INPUT_OPTIONS,
  MAKE_FUJIFILM,
} from '@/features/gallery/vendors/fujifilm';
import { FilmSimulation } from '@/features/gallery/simulation';
import { GEO_PRIVACY_ENABLED } from '@/features/gallery/site/config';
import { TAG_FAVS, getValidationMessageForTags } from '@/features/gallery/tag';
